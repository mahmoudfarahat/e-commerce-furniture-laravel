...
@section('content')
    ...
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li  class="nav-item" role="presentation">
                <a  href = "{{url("dashboard/products")}}" class="nav-link "   data-bs-toggle="tab" data-bs-target="#profile" type="button"
...
@endif
                ...
                <a href="{{ url('category/create') }}" class="btn btn-primary mt-1 mx-1">Add Category</a>
